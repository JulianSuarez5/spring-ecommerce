...
public class AdminController {
   ...
   private BrandService brandService;
    ...
    public String adminDashboard(Model model, Authentication authentication) {
        ...
        Double totalSales = orderService.getTotalSales(); // Obtenemos ventas totales
        model.addAttribute("totalSales", (totalSales != null) ? totalSales : 0.0);
        model.addAttribute("totalOrders", orderService.countOrders());// Contamos pedidos 
    ...
    public String createUserForm(Model model, Authentication authentication) {
        ...
        return "Admin/users/create"; // ✅ vista corregida
    }
    ...
    public String deleteUser(@PathVariable Integer id) {
        // Opcional: Agrega verificaciones, ej. no eliminar admins o usuarios con pedidos pendientes
