...
public class AuthController {
    ...
    public String loginPage(@RequestParam(value = "error", required = false) String error, Model model) {
        // If user already authenticated, redirect to home to avoid redirect loops
    ...
    public String registerPage() {
        // If user already authenticated, no need to register
        org.springframework.security.core.Authentication authentication = org.springframework.security.core.context.SecurityContextHolder.getContext().getAuthentication();
        if (authentication != null && authentication.isAuthenticated() && !(authentication.getPrincipal() instanceof String && "anonymousUser".equals(authentication.getPrincipal()))) {
            return "redirect:/";
        }
    ...
    public String registerAdmin(@RequestParam String username,
        ...
        // If admin already exists, require a token to create another admin
        if (adminExists) {
